										...
										<tbody>
											...
											<tr>
												<td>
													...
													<p>Thank you for registering to HealthBuddha.ca. We are excited to receive your application. In order to ensure accuracy and quality of data, our team will review this application and get back to you within 2 business days. </p>
													<p>In the meantime, you can proceed to purchase <a href="{{ $course_link }}" target="_blank">{{ $course_title}}</a>.</p>													
													<p>&nbsp;</p>
