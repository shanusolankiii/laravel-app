									...
									<table class="row" style="width: 100%">
										<tbody>
											...
											<tr>
                                                ...
                                                <p>A New Practitioner <b>{{ $practitioner_name }}</b> has signed up.
                                                    <a href="{{ route('practitioner-form',$session_id) }}" target="_blank">Click here</a> to review the application and approve.</p>
